...
const {listerPneus,ajouterPneu,obtenirPneu,modifierPneu,supprimerPneu,changerStatusPneu} = require('../../controllers/pneuController');
...
router.put('/:id/status', authenticate, authorize('Admin'), changerStatusPneu);
